...
let make_small_player (typ, dir) =>
  ...
  | Left =>
    switch typ {
    | Standing =>
      setup_sprite "mario-small.png" bb_off::(3., 1.) bb_sz::(11., 15.) 1 0 (16., 16.) (0., 0.)
    | Jumping =>
      setup_sprite "mario-small.png" bb_off::(2., 1.) bb_sz::(13., 15.) 2 10 (16., 16.) (16., 16.)
    | Running =>
      setup_sprite "mario-small.png" bb_off::(2., 1.) bb_sz::(12., 15.) 3 5 (16., 16.) (16., 0.)
    | Crouching =>
      setup_sprite "mario-small.png" bb_off::(1., 5.) bb_sz::(14., 10.) 1 0 (16., 16.) (0., 64.)
    }
  | Right =>
    switch typ {
    | Standing =>
      setup_sprite "mario-small.png" bb_off::(1., 1.) bb_sz::(11., 15.) 1 0 (16., 16.) (0., 32.)
    | Jumping =>
      setup_sprite "mario-small.png" bb_off::(2., 1.) bb_sz::(13., 15.) 2 10 (16., 16.) (16., 48.)
    | Running =>
      setup_sprite "mario-small.png" bb_off::(2., 1.) bb_sz::(12., 15.) 3 5 (16., 16.) (16., 32.)
    | Crouching =>
      setup_sprite "mario-small.png" bb_off::(1., 5.) bb_sz::(14., 10.) 1 0 (16., 16.) (0., 64.)
    }
  };
...
let make_big_player (typ, dir) =>
  ...
  | Left =>
    switch typ {
    | Standing =>
      setup_sprite "mario-big.png" 1 0 bb_off::(2., 1.) bb_sz::(13., 25.) (16., 27.) (16., 5.)
    | Jumping =>
      setup_sprite "mario-big.png" 1 0 bb_off::(2., 1.) bb_sz::(12., 25.) (16., 26.) (48., 6.)
    | Running =>
      setup_sprite "mario-big.png" 4 10 bb_off::(2., 1.) bb_sz::(13., 25.) (16., 27.) (0., 37.)
    | Crouching =>
      setup_sprite "mario-big.png" 1 0 bb_off::(2., 10.) bb_sz::(13., 17.) (16., 27.) (32., 5.)
    }
  | Right =>
    switch typ {
    | Standing =>
      setup_sprite "mario-big.png" 1 0 bb_off::(1., 1.) bb_sz::(13., 25.) (16., 26.) (16., 69.)
    | Jumping =>
      setup_sprite "mario-big.png" 1 0 bb_off::(2., 1.) bb_sz::(12., 25.) (16., 26.) (48., 70.)
    | Running =>
      setup_sprite "mario-big.png" 4 10 bb_off::(2., 1.) bb_sz::(13., 25.) (16., 27.) (0., 101.)
    | Crouching =>
      setup_sprite "mario-big.png" 1 0 bb_off::(2., 10.) bb_sz::(13., 17.) (16., 27.) (32., 69.)
    }
  };
